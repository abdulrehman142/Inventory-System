...
import type { Order, Customer } from "../inventory-dashboard"
...
export default function EditOrderForm({ order, customers, onOrderUpdated }: EditOrderFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:3000/api/oap/orders/update", {
        method: "PUT",
        headers: {
